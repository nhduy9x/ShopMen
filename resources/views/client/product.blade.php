                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4 product-item text-center">
                            <div class="item-thumb">
                                <img src="{{asset(isset($product->img)?'uploads/'.$product->img:'img/default.jpg')}}" alt="">
                                <a href=""><i class="fas fa-shopping-cart product-item-cart"></i></a>
                            </div>
                            <div class="change-list">
                                <h4 class="product-title"><a href="{{route('detail.product',$product->slug)}}" title="Áo Khoác Kaki Rêu AK260">{{$product->name}}</a></h4>
