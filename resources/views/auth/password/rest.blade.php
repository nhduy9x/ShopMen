...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="{{route('rest.pass',$user->email)}}" method="post" >
      ...
      <div class="form-group ">
        <input type="password" class="form-control" name="password" placeholder="mat khau Moi">
      ...
      <div class="social-auth-links text-center">
          ...
          <button type="submit" class="btn btn-block btn-primary" style="text-align: center;">luu</button>
